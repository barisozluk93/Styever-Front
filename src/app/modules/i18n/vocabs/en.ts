...
export const locale = {
  ...
  data: {
    ...
    TERMS: {
      ...
      SECTION_10_ITEM_1: "Official Title / Name and Surname: Styever",
    ...
    DISTANCE_SALES: {
      ...
      PRE_INFO_SELLER_1: "Legal Title: Styever",
      ...
      SECTION_1_1_ITEM_1: "Legal Title: Styever",
      ...
      SECTION_1_3_ITEM_1: "Seller: Styever",
    ...
    LEGAL_WARNING: {
      ...
      SECTION_5_TEXT: "The legal owner of Styever has the right to completely terminate Platform activities and permanently close the Website based entirely on her own commercial decision, economic necessities or technical impossibilities. In the event of Platform closure, Styever cannot be held responsible for data losses suffered by users who fail to back up their own data and photographs within the 30 (thirty) day advance notice period specified in the legal agreements. No material or non-material compensation claim may be brought against Styever on the grounds that \"sentimental memories were lost\", \"memories were deleted\" or \"damage was suffered\" as a result of the complete shutdown of the systems and permanent deletion of data in accordance with KVKK legislation.",
