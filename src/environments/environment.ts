...
export const environment = {
  ...
  isMockEnabled: true,
  appUrl: 'http://localhost:5058',
  apiUrl: 'http://localhost:5058/api',
  avatarUploadFolderUrl: "http://localhost:5058/Uploads/Avatars",
  articleUploadFolderUrl: "http://localhost:5058/Uploads/Articles",
  memoryUploadFolderUrl: "http://localhost:5058/Uploads/Memories",
  signalRUrl: 'http://localhost:5058/notificationHub',
